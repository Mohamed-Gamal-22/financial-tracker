...
export default function Footer() {
  return (
    <footer className="mt-auto bg-slate-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start text-start">
        {/* تعريف قصير */}
        <div className="md:col-span-6">
          <div className="flex items-center gap-2.5">
            <img src="logo.png" alt="" className="w-20 h-20 ms-0" />
            <span className="text-lg font-extrabold bg-gradient-to-r from-sky to-purple bg-clip-text text-transparent">مصروفي</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-card-border/60 flex flex-col sm:flex-row items-center justify-between text-xs text-text-muted font-medium gap-4">
        <span>  جميع الحقوق محفوظة لـ مصروفي &copy; {new Date().getFullYear()} </span>
